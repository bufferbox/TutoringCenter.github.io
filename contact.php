...
<html>
	...
	<body>
				  ...
				  <br>
					<div class = "col-sm-6">
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
							<input type="email" class="form-control" id="id" placeholder="Enter your email" name="email" id="email">
						  </div>
						</div>
						<div class="form-group">
						  <label class="control-label col-sm-2" for="subject">Subject:</label>
						  <div class="col-sm-10">          
							<input type="subject" class="form-control" id="subject" placeholder="Enter a subject" name="subject">
						  </div>
						</div>
						<div class="form-group">
	  ...
	  <br>
			...
			<div class = "container">
				<img class = "img-responsive center" src = "map.jpg" width="1000px" height = "800px" >
			</div>
			<br>
			<br>
		<div class = "container-fluid">
				<div class=" footer jumbotron" style="background-color:#1c1c1c; color:white; heigth:80px">
					...
					<div id="hyperlink" style="margin:0 auto; float:right;">
						...
						<span id=" white-envelope" class="glyphicon glyphicon-envelope"><a href="contact.html" target="_blank">Contact</a></span>
					</div>
				</div>
			</div>
